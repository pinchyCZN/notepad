...
static struct CONTROL_ANCHOR WordStyleAnchors[]={
	{IDC_LANG_GROUP,				ANCHOR_LEFT|ANCHOR_RIGHT|ANCHOR_TOP|ANCHOR_BOTTOM,0,0,0},
	{IDC_LANGUAGES_LIST,			ANCHOR_LEFT|ANCHOR_TOP|ANCHOR_BOTTOM,0,0,0},
	{IDC_STYLES_LIST,				ANCHOR_LEFT|ANCHOR_RIGHT|ANCHOR_TOP|ANCHOR_BOTTOM,0,0,0},
	...
	//-------------------------
	{IDC_COLOR_FONT_GROUP,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_STYLEEXAMPLE_STATIC,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_STYLEDESCRIPTION_STATIC,	ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_COLOURGROUP_STATIC,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_COLOR_PICK_FG,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_COLOR_PICK_BG,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FG_STATIC,					ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FGRGB_STATIC,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_BG_STATIC,					ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_BGRGB_STATIC,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FONTGROUP_STATIC,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FONTNAME_STATIC,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FONTSIZE_STATIC,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FONT_COMBO,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_FONTSIZE_COMBO,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_BOLD_CHECK,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_ITALIC_CHECK,				ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_UNDERLINE_CHECK,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_DEF_KEYWORDS_EDIT,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_USER_KEYWORDS_EDIT,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_DEF_KEYWORDS_STATIC,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_USER_KEYWORDS_STATIC,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_PLUSSYMBOL2_STATIC,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_FG_CHECK,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_BG_CHECK,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_FONT_CHECK,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_FONTSIZE_CHECK,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_BOLD_CHECK,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_ITALIC_CHECK,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_GLOBAL_UNDERLINE_CHECK,	ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_SAVECLOSE_BUTTON,			ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_UNDO,						ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDCANCEL,						ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_SC_TRANSPARENT_CHECK,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	{IDC_SC_PERCENTAGE_SLIDER,		ANCHOR_TOP|ANCHOR_RIGHT,0,0,0},
	//---------------------------
	{IDC_STYLER_GRIPPER,			ANCHOR_RIGHT|ANCHOR_BOTTOM,0,0,0},
};
static struct WIN_REL_POS WinRelPos={0};
static RECT default_ws_size={0};
...
BOOL CALLBACK WordStyleDlg::run_dlgProc(UINT Message, WPARAM wParam, LPARAM lParam)
{
	switch (Message)
	{
		case WM_INITDIALOG :
		{
			...
			_hStyleExampleStaticText = ::GetDlgItem(_hSelf, IDC_STYLEEXAMPLE_STATIC);

			colourHooker.hookOn(_hStyleExampleStaticText);
			...
			SetWindowLong(_pFgColour->getHSelf(),GWL_ID,IDC_COLOR_PICK_FG);
			SetWindowLong(_pBgColour->getHSelf(),GWL_ID,IDC_COLOR_PICK_BG);
			...
			GetWindowRect(_hSelf,&default_ws_size);
		...
		case WM_SIZE:
			...
			break;
		case WM_SIZING:
			return ClampMinWindowSize(&default_ws_size,wParam,(RECT*)lParam);
			break;
		case WM_DESTROY:
		{
			_pFgColour->destroy();
