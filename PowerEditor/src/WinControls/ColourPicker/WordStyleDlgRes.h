...
#define IDD_STYLER_DLG	2200
	...
	#define IDC_STYLEEXAMPLE_STATIC	(IDD_STYLER_DLG + 34)
    #define IDC_FGRGB_STATIC			(IDD_STYLER_DLG + 35)
    #define IDC_BGRGB_STATIC			(IDD_STYLER_DLG + 36)
...
# define IDD_GLOBAL_STYLER_DLG	2300
    ...
    #define IDC_UNDO	(IDD_GLOBAL_STYLER_DLG + 8)
